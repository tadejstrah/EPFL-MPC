classdef MpcControl_lon < MpcControlBase
    ...
    methods
        ...
        function ctrl_opti = setup_controller(mpc)
            ...
            for horizonindex = 1:N-1
                ...
                constraint = constraint ...
                             + (state_trajectory(:,horizonindex+1) == mpc.B * control_input_trajectory(:,horizonindex) + mpc.A * state_trajectory(:,horizonindex) + [0; mpc.B(2,1)*d_est]) ...
        ...
        function [Vs_ref, us_ref] = compute_steady_state_target(mpc, ref, d_est)
            ...
            us_ref = min(max(us - (A*(Vs_ref-xs))/B + B*d_est, -1),1);
